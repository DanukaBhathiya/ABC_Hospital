...
<html lang="en">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link active" href="about.jsp">About US</a>
        ...
        <div class="container h-contact-container">
            ...
            <p class="text-colour">
                ABC is a well-known hospital that is handling its business process using a manual information system. At present there are 5 branches spread across the country. Its Head branch is located in Colombo. It is a 75 bed, 8 consulting rooms Hospital backed by a team of highly skilled Consultants and 38 visiting specialist doctors with years of experience, qualified & experienced nursing staff, paramedical staff, state-of-the-art equipment and 24 hour Ambulance , Pharmacy and Emergency facility. The hospital provides specialized medical care at an affordable cost in over 14 specialties.
            </p>
