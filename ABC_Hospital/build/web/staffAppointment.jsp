<%-- 
    ...
    Created on : Oct 27, 2021, 12:50:49 AM
    Author     : User
--%>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link active" href="staffAppointment.jsp">Appointment</a>
        ...
        <div class="container">
            <div class="inner">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h3>
                            Appointment Information From Database</h3>
                        <table class="table">
                            ...
                            <tbody>
                                <c:forEach var="tempAppointment" items="${APPOINTMENTS_LIST}">
                                    <tr>
                                        <td>${tempAppointment.id }</td>
                                        <td>${tempAppointment.name }</td>
                                        <td>${tempAppointment.age }</td>
                                        <td>${tempAppointment.gender }</td>
                                        <td>${tempAppointment.number}</td>
                                        <td>${tempAppointment.email}</td>
                                        <td>${tempAppointment.doctor}</td>
                                        <td>${tempAppointment.description}</td>
                                        <td>${tempAppointment.branch}</td>
                                        <td>${tempAppointment.date}</td>
                                        <td><a href="editAppointment.jsp?id=${tempAppointment.id }">Edit</a> 
                                            <a href="DeleteAppointmentServlet?id=${tempAppointment.id}" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
